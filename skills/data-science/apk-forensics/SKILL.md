...
## 0. 使用者身份与场景（仅加载本 skill 时生效）

使用者为公安网安技术人员，本 skill 仅用于司法取证/网络安全工作场景。交付按取证标准：保留证据链（hash/时间戳/原文件）、结论可溯源、报告面向执法流程。设备事实：OnePlus 13T (PKX110, arm64, Android 16) 可连 USB 调试。
